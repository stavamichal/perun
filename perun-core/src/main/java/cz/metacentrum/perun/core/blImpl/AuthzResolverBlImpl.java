...
public class AuthzResolverBlImpl implements AuthzResolverBl {
	 ...
	 * @param refreshAuthzInSession if true, refresh authz in session, not if false
	 *
	 * @throws InternalErrorException
	 * @throws AlreadyAdminException
	 */
	public static void setRole(PerunSession sess, User user, Role role, List<PerunBean> complementaryObjects, boolean refreshAuthzInSession) throws InternalErrorException, AlreadyAdminException {
		...
		//Refresh authz if refreshAuthzInSession is true
		if(refreshAuthzInSession) AuthzResolverBlImpl.refreshAuthz(sess);
	}

	/**
	 * The same like method setRole(PerunSession sess, User user, Role role, List<PerunBean> complementaryObjects, boolean refreshAuthzInSession)
	 * Only use 1 complementary object!
	 */
	public static void setRole(PerunSession sess, User user, PerunBean complementaryObject, Role role, boolean refreshAuthzInSession) throws InternalErrorException, AlreadyAdminException {
		List<PerunBean> complementaryObjects = new ArrayList<>();
		complementaryObjects.add(complementaryObject);
		AuthzResolverBlImpl.setRole(sess, user, role, complementaryObjects, refreshAuthzInSession);
	}
	 ...
	 * @throws AlreadyAdminException
	 */
	public static void setRole(PerunSession sess, Group authorizedGroup, Role role, List<PerunBean> complementaryObjects, boolean refreshAuthzInSession) throws InternalErrorException, AlreadyAdminException {
		if (complementaryObjects == null || complementaryObjects.isEmpty()) {
			try {
	...
	/**
	 * The same like method setRole(PerunSession sess, Group authorizedGroup, Role role, List<PerunBean> complementaryObjects, boolean refreshAuthzInSession)
	 * Only use 1 complementary object!
	 */
	public static void setRole(PerunSession sess, Group authorizedGroup, PerunBean complementaryObject, Role role, boolean refreshAuthzInSession) throws InternalErrorException, AlreadyAdminException {
		List<PerunBean> complementaryObjects = new ArrayList<>();
		complementaryObjects.add(complementaryObject);
		AuthzResolverBlImpl.setRole(sess, authorizedGroup, role, complementaryObjects, refreshAuthzInSession);
	}
	 ...
	 */
	public static void unsetRole(PerunSession sess, User user, Role role, List<PerunBean> complementaryObjects, boolean refreshAuthzInSession) throws InternalErrorException, UserNotAdminException {
		if (complementaryObjects == null || complementaryObjects.isEmpty()) {
			try {
	...
	/**
	 * The same like method unsetRole(PerunSession sess, User user, Role role, List<PerunBean> complementaryObjects, boolean refreshAuthzInSession)
	 * Only use 1 complementary object!
	 */
	public static void unsetRole(PerunSession sess, User user, PerunBean complementaryObject, Role role, boolean refreshAuthzInSession) throws InternalErrorException, UserNotAdminException {
		List<PerunBean> complementaryObjects = new ArrayList<>();
		complementaryObjects.add(complementaryObject);
		AuthzResolverBlImpl.unsetRole(sess, user, role, complementaryObjects, refreshAuthzInSession);
	}
	 ...
	 */
	public static void unsetRole(PerunSession sess, Group authorizedGroup, Role role, List<PerunBean> complementaryObjects, boolean refreshAuthzInSession) throws InternalErrorException, GroupNotAdminException {
		if (complementaryObjects == null || complementaryObjects.isEmpty()) {
			try {
	...
	/**
	 * The same like method unsetRole(PerunSession sess, Group authorizedGroup, Role role, List<PerunBean> complementaryObjects, boolean refreshAuthzInSession)
	 * Only use 1 complementary object!
	 */
	public static void unsetRole(PerunSession sess, Group authorizedGroup, PerunBean complementaryObject, Role role, boolean refreshAuthzInSession) throws InternalErrorException, GroupNotAdminException {
		List<PerunBean> complementaryObjects = new ArrayList<>();
		complementaryObjects.add(complementaryObject);
		AuthzResolverBlImpl.unsetRole(sess, authorizedGroup, role, complementaryObjects, refreshAuthzInSession);
	}
